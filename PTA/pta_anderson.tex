...
\begin{align}
    g_a \ &\equiv \ \left[ \Gamma N \left(2 \frac{|\psi_1|^2|\psi_N|^2}{|\psi_1|^2 + |\psi_N|^2} \right)\right] \\
    g(E) \ &= \ \textrm{Local average }\left[ g_a \right]
\end{align}
...
\begin{align}
    g_h \ &= \ \textrm{Global average }\left[ g_a \right]
\end{align}
