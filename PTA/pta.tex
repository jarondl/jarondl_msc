...
A periodic banded logbox model. The band profile is flat, and
%
\begin{align}
...
These plots are for $N=1000$ and $b=5$.

Low $\sigma$ means almost no disorder.

\includegraphics{pta_low_s}


The $\sigma$s a bit higher:


\includegraphics{pta_higher_s}


And even higher:


\includegraphics{pta_highest_s}


The same values for $\sigma$ but in log scale to highlight the low-$\lambda$
behavior.


\includegraphics{pta_highest_s_log}
