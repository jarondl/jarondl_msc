...
%%%%%%%%%
\section{Geometrical implications}%% to combine with 2.1, and make thiner
% what has rescaling to do with it? discriminate geometry from statistics.
...
%% make sure the reader knows who created VRH, no false attribution.
% they generalized to treat this kind of matrices.
