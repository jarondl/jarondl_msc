...
from .libdl.plotdl import plt, tight_layout, cummulative_plot, get_LogNLocator
...
def h5_get_data(h5file, data_factory, factory_args = dict(number_of_points=1000, model_name = "anderson dd")
                                        , bandwidths=(5,), dis_params=(1,), tbl_grp ='/ev_and_pn', tbl_cls = None):
    """ h"""
...
def anderson_data_factory(model_name, number_of_points, bandwidth, dis_param):
...
def plotf_anderson_forptatex():
    with tables.openFile("ev_and_pn.hdf5", mode = "a", title = "Eigenvalues and PN") as h5file:
        ...
        runs1000_ROD = h5_get_data(h5file, anderson_data_factory, factory_args = dict(number_of_points=1000, model_name="Banded tri-diagonal disorder"),
                                            bandwidths=(5,), dis_params= (0.1,))
        runs1000_ROD_SC = h5_get_data(h5file, anderson_data_factory, factory_args = dict(number_of_points=1000, model_name="Banded tri-diagonal disorder sc"),
                                            bandwidths=(5,), dis_params= (0.1,))
        ...
        run_very_strong= h5_get_data(h5file, anderson_data_factory, factory_args = dict(number_of_points=2000, model_name="Banded diagonal disorder"),
        ...
        plotf_ev(runs_BD_SC, figfilename="pta_banded_sc_ev")
        plotf_anderson(runs_BD_SC, figfilename="pta_banded_sc_pn")
    
        runs_BD = h5_get_data(h5file, anderson_data_factory, factory_args = dict(number_of_points=1000, model_name="Banded band-disorder"),
                                            bandwidths=(5,), dis_params= (0.1,1,2,3))
        plotf_ev(runs_BD, figfilename="pta_banded_ev")
        plotf_anderson(runs_BD, figfilename="pta_banded_pn")
