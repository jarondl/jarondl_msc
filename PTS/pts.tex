...
\begin{figure}[H]
  ...
  \caption{Theoretical results for a chain model. The blue line is the power of the spreading. It shows a sub-diffusive regime where $0<s<1$, and a diffusive regime for $s>1$. The red line is of the diffusion constant $D$, which can only be defined for the diffusive regime $s>1$. It is dimensionless as we set $r_0=1$.}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%5
\begin{figure}[H]
\includegraphics[clip,width=0.9\hsize]{exp_2d_D_vs_subD}
...
%%%%%%%%%%%%%%%%
\begin{figure}[H]
\includegraphics[clip,width=0.9\hsize]{ERH}
\caption{Diffusion coefficient, numerical fit results vs ERH. The dots are numerical fit results, extracted from plots such as \ref{fig:exp_2d_D_vs_subD}. The dashed line is of the LRT result, and the solid lines are for ERH with several selections of $p_c$. It can be seen that $p_c = 5$ is a plausible option.}
\end{figure}
