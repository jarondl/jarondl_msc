...
%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Solving nearest neighbor alternating transition rates analyticaly}
...
\end{align}
The $k$'s are $k=\frac{2\pi}{N}m$, but with degeneracy of $2$ ($\pm k$ give the same result) and therefore the cummulative eigenvalues are:
\begin{align}
...
%%%%%%%%%%%%%%
\section{Solving the spacing distribution for uniformally random points in d dimensions} \label{subsec:euclid}
...
In 2D that becomes:
\[ C(\lambda) = e^{-\frac{\pi}{2} (n\xi)^2 \left(\log(\frac{\lambda}{2})\right)^2 } \]
This cummulative distribution is the same as the lognormal probability distribution. 

%%%%%%%%%%%%%%%%%%%%%%
\section{The survival and spreading for the one dimensional problem}
...
\end{figure}
\begin{figure}
    \includegraphics[clip, width=0.9\hsize]{eigvals_ones}\begin{align}
\end{figure}
\begin{figure}
...
\end{figure}
\begin{figure}
    \includegraphics[clip, width=0.9\hsize]{torus_avg}
