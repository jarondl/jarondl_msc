...
G_{\textrm{thermal}} &= 
\end{align}
\rmrk{ In Zheng's PRE and other sources, there are only two elements in the 
$G$ expression, but apparently that's because $b=1$. In the
newer Kottos paper there is a sum over b, with four matrix elements....}
