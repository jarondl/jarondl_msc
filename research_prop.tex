...
To compare this result to the obtained eigenvalues, we have created a $1d$ system with random log-normaly distributed transition rates, and calculted the diffusion, see figure \ref{fig:quasi_1d}.
\begin{figure}
