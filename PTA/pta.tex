...
\caption{PN vs. eigenvalues for the "Anderson-Rate" colongbibliography,nserving model ( $w_{ij} = 1 + \left[-\frac{s}{2}, \frac{s}{2}\right]$), 2000 sites. 
