...
\begin{figure}[H]
 ...
 % \begin{figure}[H]
  %
    ...
    \includegraphics{pta_low_s_pin_effect}
  ...
  \end{subfigure}
  \caption{(\subref{fig:PN_kottos_nopin}\subref{fig:PN_kottos_sparse}\subref{fig:PN_kottos_pinning}) - {\bf PN} as a function of $\lambda$.
