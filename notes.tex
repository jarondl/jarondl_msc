...
\[ \boldsymbol{ \dot P } = W \boldsymbol{P} \]
It can be rewritten as:
\[  \boldsymbol{P} = W^{-1}\boldsymbol{ \dot P } \]
...
\begin{figure}
    ...
    \\ \subfloat[Lognoraml banded matrix]{\includegraphics[clip, width=0.9\hsize]{eigvals_lognormal}}
