...
\end{verbatim}
After this installation, the jarondl_msc package will be available,
...
\begin{verbatim}
python -m research_dl.ptsplot
\end{verbatim}
If the data for the banded matrices does not exist (as is excpected in the first run),
the data will be populated, and only then will the graphs be made. Following runs should be
quicker, as they use the previous data.
