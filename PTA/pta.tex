...
Are questions are what are the implications of several properties on the 
...
\item   If the disorder matrix is conservative (all row sums equal), 
        ...
        eigenvalues close to the ergodic mode? do they have large $PN$?
\item   If all matrix elements are positive, and the matrix is conservative,
        ...
        where will the ergodic mode be?
...
For presentation purposes, we shall divide the matrix into two parts,
an ordered $W_0$, and a disordered $V$:
%
\begin{align}
W \ = \ W_0 \ + \ V
\end{align}
