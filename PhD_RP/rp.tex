...
%%%  pts
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[onecolumn,fleqn,12pt,openany,a4paper,longbibliography]{book}
...
\usepackage[pdfencoding=auto,colorlinks=true,pdftitle={Research Proposal}]{hyperref}
...
\part{Completed Work and Preliminary Analysis}
...
\bibliography{jarondl,custom-longbib}
