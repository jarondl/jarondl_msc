...
\fill[white,xshift=8cm]  (-3.9,0) rectangle (4,-6.1);
\end{tikzpicture}
...
\end{align}
\rmrk{ The idea is to "cut" all the heat going from $j<n$ to $i\ge n$. Kottos'
version is specific for the banded matrix}
\begin{align}
