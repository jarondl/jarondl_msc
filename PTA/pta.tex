...
%
\begin{align}
  g = \frac{|\lambda_\phi - \lambda_0 |}{\phi^2}\ \times \ \textrm{LDOS}
\end{align}
%
Where local-density-of-states (LDOS) is the inverse of the level spacing 
($\frac{1}{\lambda_{n+1}-\lambda_n}$). In practice, we have averaged over five 
