...
\item
Understand the different outcomes for the same matrix in different 
settings.
\end{itemize}
...
\end{align*}
Where $\lambda$ is the mean free path. This expression should 
work for all values of $\frac{L}{\lambda}$.
