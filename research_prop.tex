...
\begin{figure}
\subfloat{
    \includegraphics[clip, width=0.45\hsize]{exp_1d_0__2_pn.pdf}} 
\subfloat{
    \includegraphics[clip, width=0.45\hsize]{exp_2d_0__2_pn.pdf}}\\
\subfloat{
    \includegraphics[clip, width=0.45\hsize]{exp_1d_1__5_pn.pdf} }
\subfloat{
    \includegraphics[clip, width=0.45\hsize]{exp_2d_1__5_pn.pdf}}\\
\subfloat{
    \includegraphics[clip, width=0.45\hsize]{exp_1d_5_pn}}
\subfloat{
    \includegraphics[clip, width=0.45\hsize]{exp_2d_5_pn.pdf}}
